...
function ListCustomer() {
    ...
    useEffect(() => {
      async function createData() {
        await axios.get('http://localhost:8082/cliente').then(resp => {
    ...
    async function ExcludeUser(value){
      await axios.delete(`http://localhost:8082/cliente/${value._id}`).then(resp => {
            setOpenSnack(true)
    ...
    async function editUser (value) {
      ...
      console.log(Dados)
      await axios.put(`http://localhost:8082/cliente/${value._id}`, Dados).then(resp => {
        setOpenSnack(true)
  ...
  return (
    ...
    <div>
    <Typography variant="h5" component="div" m={2} fontFamily="Times New Roman">Usuários :</Typography>
        ...
        <TableBody>
          {rows.map((row, index) => (
            <StyledTableRow key={index}>
              ...
              <StyledTableCell align="right">{row.endereço}</StyledTableCell>
            ...
            >
                <Grid item>
                    ...
                    >
                        ...
                        <Grid item>
                            <TextField id="Telefone" label="Telefone" defaultValue={user.telefone} variant="outlined" sx={{ m: 2 }} onChange={(e) => setTelefone(e.target.value)} />
                        </Grid>
                        <Grid item>
                            <TextField id="Endereço" label="Endereço" defaultValue={user.endereço} variant="outlined" sx={{ m: 2 }} onChange={(e) => setEndereco(e.target.value)} />
                        </Grid>
                        <Grid item>
